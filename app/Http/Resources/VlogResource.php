...
class VlogResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'thumbed' => (int)Thumb::where("user_id",$user->id)->where("vlog_id",$this->id)->exists()?1:0,
            'collected' => (int)Collection::where("user_id",$user->id)->where("vlog_id",$this->id)->exists()?1:0,
